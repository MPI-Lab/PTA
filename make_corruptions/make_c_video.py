...
def frost(x, severity=1):
    ...
    filename = ['/XXXXXX/make_corruptions/frost1.png', '/XXXXXX/make_corruptions/frost2.png', '/XXXXXX/make_corruptions/frost3.png', '/XXXXXX/make_corruptions/frost4.jpg', '/XXXXXX/make_corruptions/frost5.jpg', '/XXXXXX/make_corruptions/frost6.jpg'][idx]
...
parser.add_argument('--corruption', type=str, default='all', choices=['all', 'gaussian_noise', 'shot_noise', 'impulse_noise', 'defocus_blur', 'glass_blur', 'motion_blur', 'zoom_blur', 'snow', 'frost', 'fog', 'brightness', 'contrast', 'elastic_transform', 'pixelate', 'jpeg_compression'], help='Type of corruption to apply')
parser.add_argument('--severity', type=int, default=5, choices=[1, 2, 3, 4, 5], help='Severity of corruption to apply')
parser.add_argument('--data_path', type=str, default='/XXXXXX/Kinetics50/image_mulframe_val256_k=50', help='Path to test data')
parser.add_argument('--save_path', type=str, default='XXXXXX/Kinetics50/image_mulframe_val256_k=50-C', help='Path to store corruption data')
args = parser.parse_args()
# --data_path /XXXXXX/data/VGGSound/image_mulframe_test
# --save_path /XXXXXX/data/VGGSound/image_mulframe_test-C
